...
public final class BudgetDao_Impl implements BudgetDao {
  ...
  public BudgetDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBudgetEntity = new EntityInsertionAdapter<BudgetEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `budgets` (`id`,`categoryId`,`amount`,`yearMonth`) VALUES (?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(4, entity.getYearMonth());
      }
    };
  ...
  public Flow<List<BudgetEntity>> getBudgetsByMonth(final String yearMonth) {
    final String _sql = "SELECT * FROM budgets WHERE yearMonth = ? ORDER BY categoryId";
      ...
      public List<BudgetEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new BudgetEntity(_tmpId,_tmpCategoryId,_tmpAmount,_tmpYearMonth);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getBudget(final String categoryId, final String yearMonth,
      final Continuation<? super BudgetEntity> $completion) {
    final String _sql = "SELECT * FROM budgets WHERE categoryId = ? AND yearMonth = ? LIMIT 1";
      ...
      public BudgetEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpYearMonth;
            _tmpYearMonth = _cursor.getString(_cursorIndexOfYearMonth);
            _result = new BudgetEntity(_tmpId,_tmpCategoryId,_tmpAmount,_tmpYearMonth);
          } else {
            _result = null;
          }
          return _result;
